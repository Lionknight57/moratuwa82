...
export const memberPhotos: MemberPhoto[] = [
  ...
  { name: 'Chandana Vidanarachchi', sourceFile: 'Chandana_V.jpg', publicId: 'member/chandana-vidanarachchi' },
  ...
  { name: 'Dayawansa Rupasinghe', sourceFile: 'Rupasinghe.jpg', publicId: 'member/daya-rupasinghe' },
  ...
  { name: 'Lalith Munasinghe - Ven Kalaniye Sidaththa', sourceFile: 'munasinghe.jpg', publicId: 'member/lalith-munasinghe' },
  ...
  { name: 'Piyadasa Amarasinghe', sourceFile: 'Piyadasa.jpg', publicId: 'member/piyadasa-amaratunga' },
  ...
  { name: 'Saman Kanakaratne', sourceFile: 'Saman_Kanaka.jpg', publicId: 'member/saman-kanakaratne' },
  { name: 'Sandaruwan Perera', sourceFile: 'Sandaruwan_from_power.jpg', publicId: 'member/sandaruwan-perera' },
  ...
  { name: 'Sivasubramaniam Shanmuganantha', sourceFile: 'Shanmuganathan.jpg', publicId: 'member/shanmuganathan' },
  { name: 'Siri Dissanayake', sourceFile: 'Dissanayake.jpg', publicId: 'member/siri-dissanayake' },
  { name: 'Sivasakthy Sett', sourceFile: 'sivasakthy.jpg', publicId: 'member/sivasakthy' },
  { name: 'Sriyani Weerakkody (Karunanayake)', sourceFile: 'sriyani.jpg', publicId: 'member/sriyani-karunatilleke' },
  { name: 'Sudharma Hemamali Gajadeera', sourceFile: 'Hemamali.jpg', publicId: 'member/hemamali-gajadeera' },
  { name: 'Sumi Prabhakaran (Maheswaran)', sourceFile: 'Sumi Prabhakaran.jpg', publicId: 'member/sumi-prabakharan' },
  ...
  { name: 'Uthpala Siriwardene', sourceFile: 'Uthpala_from_power.jpg', publicId: 'member/uthpala-siriwardene' },
